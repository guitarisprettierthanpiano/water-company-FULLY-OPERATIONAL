    ...
    <div className='careers-container'>
        ...
        <div className='container-careers-a-message'>
            <div className='careers-a-message'>
                <span style={{fontWeight: 800}}><img src='images/gigachad.png' className='round'/>A message from Steven:</span>
                <br/>
        ...
        <div className='careers-at'>
            ...
            <div className='careers-at-br'>
                ...
                <br/>
                <p>Steven Gas has been serving central North Carolina for over 100 years, offering talented professionals the opportunity to serve more than one million customers in the region. Steven Gas is not your average natural gas utility. Our vision is:</p>
                <br/>
                <ul>
